report 50000 "ANT Standard Sales - Invoice"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(GeneralTermsLbl; GeneralTermsLbl)
            {
            }
            ...
            // {
            // }
            column(CompanyVATRegNo_Lbl; CompanyVATRegNo_Lbl)
            {
            }
            ...
            column(ExternalDocumentNo_Lbl; ExternalDocumentLbl)
            {
            }
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(LineAmount_Line_Lbl; TotalamountLbl)
                {
                }
                column(ItemNo_Line; "No.")
                {
                }
                column(ItemNo_Line_Lbl; ItemLbl)
                {
                }
                ...
                column(TransHeaderQty; Format(TransHeaderQty))
                {
                }
                ...
                column(SubTotalAmount; TotalSubTotal)
                {
                    AutoFormatExpression = Header."Currency Code";
                    AutoFormatType = 1;
                }
    ...
    var
        ...
        ExternalDocumentLbl: Label 'Order number Maya';
        ItemLbl: Label 'Item';
        ...
        GeneralTermsLbl: label 'Our general terms and conditions apply to all our transactions, as filed at the Chamber of Commerce under number 30079089';
        OfLbl: Label 'of';
        CompanyVATRegNo_Lbl: Label 'VAT Registration No.';
    ...
    begin
        ...
        if TotalAmountVAT <> 0 then
            ReportTotalsLine.Add(uppercase(VATAmountLine.VATAmountText), TotalAmountVAT, false, true, false);
    end;
    ...
    begin
        FormatAddr.FormatAddr(
            CompanyAddr, CompanyInfo.Name, CompanyInfo."Name 2", '', CompanyInfo.Address, CompanyInfo."Address 2",
        ...
        CompanyAddr[8] := CompanyInfo."Home Page";
